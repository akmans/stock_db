...
public class GenerateHourApp {

	private final static org.slf4j.Logger logger = LoggerFactory.getLogger(GenerateHourApp.class);
	...
	public static void main(String[] args) throws Exception {
		...
		String jobId = FXJob.GENERATE_FX_HOUR_JOB.getValue();
