...
public class Generate6HourApp {

	private final static org.slf4j.Logger logger = LoggerFactory.getLogger(Generate6HourApp.class);
	...
	public static void main(String[] args) throws Exception {
		...
		String jobId = FXJob.GENERATE_FX_6HOUR_JOB.getValue();
