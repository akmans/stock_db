...
public class GenerateDayApp {

	private final static org.slf4j.Logger logger = LoggerFactory.getLogger(GenerateDayApp.class);
	...
	public static void main(String[] args) throws Exception {
		...
		String jobId = FXJob.GENERATE_FX_DAY_JOB.getValue();
