...
public class TrnFXMonthRepositoryTest {
	...
	@DatabaseSetup(type = DatabaseOperation.INSERT, value = "/data/fx/repositories/fxmonth/delete/input.xml")
	...
	@Test
	@DatabaseSetup(type = DatabaseOperation.DELETE_ALL, value = {"/data/fx/emptyAll.xml"})
	@DatabaseSetup(type = DatabaseOperation.INSERT, value = "/data/fx/repositories/fxmonth/find/input.xml")
