...
public class FXWeekServiceImplTest {
	...
	@DatabaseSetup(type = DatabaseOperation.INSERT, value = "/data/fx/service/fxweek/find/input.xml")
	...
	@Test
	@DatabaseSetup(type = DatabaseOperation.DELETE_ALL, value = {"/data/fx/emptyAll.xml"})
	@DatabaseSetup(type = DatabaseOperation.INSERT, value = "/data/fx/service/fxweek/operation/input4Update.xml")
	...
	public void testOperation4DeleteWithMock() throws Exception {
		...
		newWeek.setUpdatedDate(ZonedDateTime.now().plusHours(1l));
		// Execute the method being tested with validation.
	...
	@Test
	@DatabaseSetup(type = DatabaseOperation.DELETE_ALL, value = {"/data/fx/emptyAll.xml"})
	@DatabaseSetup(type = DatabaseOperation.INSERT, value = "/data/fx/service/fxweek/operation/input4Delete.xml")
