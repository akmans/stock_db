...
public class FX6HourServiceImplTest {
	...
	public void testFindOneWithMock() throws Exception {
		...
		FX6HourService fx6HourService = new FX6HourServiceImpl(fxHourService, trnFX6HourRepository, messageService);
		/** 1. Test found */
		// New FXTickKey
	...
	@DatabaseSetup(type = DatabaseOperation.INSERT, value = "/data/fx/service/fx6hour/find/input.xml")
	...
	@Test
	@DatabaseSetup(type = DatabaseOperation.DELETE_ALL, value = {"/data/fx/emptyAll.xml"})
	@DatabaseSetup(type = DatabaseOperation.INSERT, value = "/data/fx/service/fx6hour/operation/input4Update.xml")
	...
	@Test
	@DatabaseSetup(type = DatabaseOperation.DELETE_ALL, value = {"/data/fx/emptyAll.xml"})
	@DatabaseSetup(type = DatabaseOperation.INSERT, value = "/data/fx/service/fx6hour/operation/input4Delete.xml")
