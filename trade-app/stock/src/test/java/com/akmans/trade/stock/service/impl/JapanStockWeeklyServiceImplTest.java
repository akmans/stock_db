...
public class JapanStockWeeklyServiceImplTest {

	@Autowired
	private JapanStockWeeklyService japanStockWeeklyService;

	@Test
	@DatabaseSetup(type = DatabaseOperation.INSERT, value = "/data/stock/service/japanstockweekly/find/input.xml")
	...
	public void testFind() throws Exception {
		...
		TrnJapanStockWeekly japanStock = japanStockWeeklyService.findOne(key);
		...
		boolean result1 = japanStockWeeklyService.exist(key1);
		// Check result.
		...
		// Get one from DB by key.
		boolean result2 = japanStockWeeklyService.exist(key2);
		// Check result.
		assertEquals(false, result2);
	}

	@Test
	@DatabaseSetup(type = DatabaseOperation.INSERT, value = "/data/stock/service/japanstockweekly/operation/input4Insert.xml")
	@ExpectedDatabase(value = "/data/stock/service/japanstockweekly/operation/expectedData4Insert.xml", table = "trn_japan_stock_weekly", assertionMode = DatabaseAssertionMode.NON_STRICT)
	@DatabaseTearDown(type = DatabaseOperation.DELETE_ALL, value = "/data/stock/emptyAll.xml")
	public void testOperation4Insert() throws Exception {
		...
		TrnJapanStockWeekly japanStock = new TrnJapanStockWeekly();
		...
		// Do insert.
		japanStockWeeklyService.operation(japanStock, OperationMode.NEW);
	}

	@Test
	@DatabaseSetup(type = DatabaseOperation.INSERT, value = "/data/stock/service/japanstockweekly/operation/input4Update.xml")
	@ExpectedDatabase(value = "/data/stock/service/japanstockweekly/operation/expectedData4Update.xml", table = "trn_japan_stock_weekly", assertionMode = DatabaseAssertionMode.NON_STRICT)
	@DatabaseTearDown(type = DatabaseOperation.DELETE_ALL, value = "/data/stock/emptyAll.xml")
	public void testOperation4Update() throws Exception {
		...
		// Do update.
		japanStockWeeklyService.operation(japanStock, OperationMode.EDIT);
	}

	@Test
	@DatabaseSetup(type = DatabaseOperation.INSERT, value = "/data/stock/service/japanstockweekly/operation/input4Delete.xml")
	@ExpectedDatabase(value = "/data/stock/service/japanstockweekly/operation/expectedData4Delete.xml", table = "trn_japan_stock_weekly")
	@DatabaseTearDown(type = DatabaseOperation.DELETE_ALL, value = "/data/stock/emptyAll.xml")
	public void testOperation4Delete() throws Exception {
		...
		japanStockWeeklyService.operation(japanStock, OperationMode.DELETE);
	}
}
