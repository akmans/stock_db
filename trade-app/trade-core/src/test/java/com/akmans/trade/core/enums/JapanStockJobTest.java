...
public class JapanStockJobTest {
	...
	public void testJapanStockJob() {
		...
		assertEquals(JapanStockJob.IMPORT_JAPAN_STOCK_WEEKLY_JOB.toString(), "importJapanStockWeeklyJob");
		...
		assertEquals(JapanStockJob.IMPORT_JAPAN_STOCK_WEEKLY_JOB.toString(),
				JapanStockJob.IMPORT_JAPAN_STOCK_WEEKLY_JOB.getValue());
		// Test Label.
		...
		assertEquals(JapanStockJob.IMPORT_JAPAN_STOCK_WEEKLY_JOB.getLabel(), "2 : 日本株週足データ導入処理");
		// Test lookup(get).
		...
		assertEquals(JapanStockJob.get("importJapanStockWeeklyJob"), JapanStockJob.IMPORT_JAPAN_STOCK_WEEKLY_JOB);
	}
}
