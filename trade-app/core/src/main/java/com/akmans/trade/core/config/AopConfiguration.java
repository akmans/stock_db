...
public class AopConfiguration {
	...
	@Pointcut("execution(public * (@org.springframework.stereotype.Service com.akmans.trade.*.service.impl..*).*(..))")
	public void serviceAnnotation() {
	}

	/** Pointcut for execution of methods on {@link Repository} annotation */
	@Pointcut("execution(public * (@org.springframework.stereotype.Repository com.akmans.trade.*.springdata.jpa.repositories..*).*(..))")
