...
import com.akmans.trade.cashing.springdata.jpa.repositories.TrnSpecialDetailRepository;
...
public class SpecialDetailServiceImpl implements SpecialDetailService {
	...
	private final static org.slf4j.Logger logger = LoggerFactory.getLogger(SpecialDetailServiceImpl.class);
